...
import SvgAbout from "../../componentes/svg-about/SvgAbout";
    ...
    <div className="body-about">
      <main className="content-text-about">
        <div className="title">
          ...
          <h2 className="headers header-h2-ligth  secondtitle">y mis cosas</h2>
          <span className="ornament">&lt;/h2&gt;</span>
        </div>
        <div className="container-paragraph">
          ...
          <p className="paragraph text-about">
            ...
            <p className="margin">
              Este es el código que mueve mi mundo, con él me podréis entender.
            </p>
            <p className="margin">
              {" "}
            ...
            <p className="margin">
              ...
              <span className="stress">experiencias únicas y cautivadoras</span>
              .
            </p>
            <p className="margin">
              {" "}
              ...
              Esta me transporta a un lugar donde puedo expresar mis emociones y
              soñar con mis próximos proyectos. También me encanta experimentar
              con sabores y texturas, mancharme las manos creando platos
              deliciosos que deleitan el paladar. Además, a través de trazos y
              colores, puedo plasmar mis{" "}
            ...
            <p className="margin">
              ...
              historias, nada se compara con un buen libro o una buena partida a
              la Nintendo Switch.{" "}
              ...
              Esto me permite escapar a mundos fascinantes, inspirarme de nuevas
              ideas y descubrir personajes memorables. Cada aventura es un
              portal hacia la imaginación y el conocimiento.{" "}
